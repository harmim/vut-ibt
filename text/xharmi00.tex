...
\usepackage[ruled, algochapter, lined, longend, linesnumbered]{algorithm2e}
...
% Hyphenation of czech words.
\hyphenation{a-to-mic-ky}
\hyphenation{a-to-mi-ci-ty}
...
%
    ...
    abstract.cs={%
        ...
        testovacích programech, které vznikly ze skutečných nízko úrovňových
        programů.
    },
    % abstract in english
    abstract.en={%
